...
func test_expand_retract():
	...
	assert_false(tname.visible, "should be false checked setup")
	assert_false(tcont.visible, "should be false checked setup")
	assert_false(tbuttons.visible, "should be false checked setup")
	token.expand()
	assert_true(tname.visible, "should be true checked expand")
	assert_true(tcont.visible, "should be true checked expand")
	assert_true(tbuttons.visible, "should be true checked expand")
	token.retract()
	assert_false(tname.visible, "should be false checked retract")
	assert_false(tcont.visible, "should be false checked retract")
	assert_false(tbuttons.visible, "should be false checked retract")
