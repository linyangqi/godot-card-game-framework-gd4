...
# TODO: I should make 2 scenes just for UT so I don't rely checked these which
# might get deleted
...
# We need this for targetting arrows which don't release back checked the card gui
