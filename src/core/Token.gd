...
@export var count := 0 :
	get:
		return count # TODOConverter40 Copy here content of get_count
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_count
...
# based checked the values in the configuration
