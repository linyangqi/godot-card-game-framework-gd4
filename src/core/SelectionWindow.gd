...
func initiate_selection(
	...
	# We don't want to show a popup longer than the cards. So the width is based checked the lowest
	...
	# The height will be automatically adjusted based checked the amount of cards
...
# Manually selects cards based checked their index.
