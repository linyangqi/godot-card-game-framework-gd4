...
# it discovers in your card base. This buttons can be toggled checked/unchecked
# for quick filtering
#
...
# is only used checked properties with few distinct values.
#
...
## Prepares the filter buttons based checked the unique values in cards.
...
func _process(_delta: float) -> void:
	# We keep updating the columns based checked the card size
